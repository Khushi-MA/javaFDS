...
//     // Process the data to count the number of requests per day
// const counts = foodreq.reduce((acc, item) => {
//     const date = item.date_of_req.split('T')[0]; // Get the date part of the timestamp
                    ...
                    <tbody>
                        {
                            foodreq.map((foodreq, index) => (
                                <tr>
                                    ...
                                    <td>{foodreq.date_of_collection}</td>
